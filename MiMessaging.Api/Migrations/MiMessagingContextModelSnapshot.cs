...
namespace MiMessaging.Api.Migrations
{
    ...
    partial class MiMessagingContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MiMessaging.Entities.MessagingDomain.MessageReadStatus", b =>
                {
                    b.Property<Guid>("ParticipantId");

                    b.Property<Guid>("MessageId");

                    b.Property<Guid?>("ParticipantConversationId");
                    ...
                    b.HasKey("ParticipantId", "MessageId");

                    b.HasIndex("MessageId");

                    b.HasIndex("ParticipantConversationId", "ParticipantId1");
            ...
            modelBuilder.Entity("MiMessaging.Entities.MessagingDomain.MessageReadStatus", b =>
                {
                    b.HasOne("MiMessaging.Entities.MessagingDomain.Message", "Message")
                        .WithMany()
                        .HasForeignKey("MessageId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("MiMessaging.Entities.MessagingDomain.ConversationParticipant", "Participant")
                        .WithMany()
                        .HasForeignKey("ParticipantConversationId", "ParticipantId1");
                });
